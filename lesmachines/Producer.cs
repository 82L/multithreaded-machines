...
{
    /// <summary>
    /// Producer, from Machine. Create resources and put it inside basket.
    /// </summary>
    class Producer : Machine
    {
        ...
        /// <param name="basket">Basket to give resources to</param>
        public Producer(int id, int minMakingDurationForResource, int maxMakingDurationForResource, Basket basket)
